...
data class Letter(val position: Int, val value: String = BLANK) {
    ...
    sealed class State {
        ...
        data class Undefined(
            override val backgroundColorRes: Int = R.color.letter_undefined,
            override val priority: Int = Priority.UNDEFINED,
            override val textColorRes: Int = R.color.text
        ): State()

        data class NotIn(
            override val backgroundColorRes: Int = R.color.letter_not_in,
        ...
        sealed class In : State() {
            data class Mismatched(
                override val backgroundColorRes: Int = R.color.letter_mismatched,
                override val priority: Int = Priority.MISMATCHED,
                override val textColorRes: Int = R.color.black
            ) : In()

            data class Matched(
                override val backgroundColorRes: Int = R.color.letter_matched,
