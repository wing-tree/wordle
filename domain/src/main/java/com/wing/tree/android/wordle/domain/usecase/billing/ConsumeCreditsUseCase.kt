...
class ConsumeCreditsUseCase @Inject constructor(
    private val repository: PreferencesRepository,
    @IOCoroutineDispatcher coroutineDispatcher: CoroutineDispatcher
) : CoroutineUseCase<Int, Boolean>(coroutineDispatcher) {
    override suspend fun execute(parameter: Int): Boolean {
        return repository.consumeCredits(parameter)
    }
}